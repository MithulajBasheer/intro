...
const locations=[
    ...
    },
    {
        ...
        text:'The monster screams "Arg!" as it dies . You get experience points and find gold'
    },
    {
        name: "lose",
        "button text":["Replay ?","Replay ?","Replay ?"],
        "button functions":[restart,restart,restart],
        text:"You Dies. Game Over"
    },
    {
        name: "win",
        "button text":["Replay ?","Replay ?","Replay ?"],
    ...
    },
    {
        ...
        text:"You find a secret game,pick a number above.Ten numbers will be randomly chosen between 0 to 10. If the number matches one of the random numbers ,You win"
    }
];
